...
import (
	...
	"github.com/yongsuha/TicketTrain/toB-train-rpc/pkg/db"
	"github.com/yongsuha/TicketTrain/toB-train-rpc/pkg/redisCli"
	"github.com/yongsuha/TicketTrain/toB-train-rpc/source/data/mysql"
	"log"
)
...
func main() {
	var config Config
	_, err := toml.DecodeFile("/root/TicketTrain/toB-train-rpc/config/config.toml", &config)
	if err != nil {
